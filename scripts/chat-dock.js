...
(function () {
  ...
  var MODEL = cfg.model || (PROVIDER === "openai" ? "gpt-5.6-terra" : "claude-sonnet-4-6");
  ...
  function ask(q){
    ...
    var req = PROVIDER === "openai" ? {
      ...
      body: { model: MODEL, max_completion_tokens: 2000, messages: [{role:"system",content:sys}].concat(history) },
